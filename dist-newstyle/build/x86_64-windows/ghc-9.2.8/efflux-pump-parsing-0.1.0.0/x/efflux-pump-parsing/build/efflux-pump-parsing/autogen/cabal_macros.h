...
/* package efflux-pump-parsing-0.1.0.0 */
#ifndef VERSION_efflux_pump_parsing
#define VERSION_efflux_pump_parsing "0.1.0.0"
#endif /* VERSION_efflux_pump_parsing */
#ifndef MIN_VERSION_efflux_pump_parsing
#define MIN_VERSION_efflux_pump_parsing(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_efflux_pump_parsing */
...
#define CURRENT_COMPONENT_ID "efflux-pump-parsing-0.1.0.0-inplace-efflux-pump-parsing"
